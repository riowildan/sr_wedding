            ...
            <div class="checkout-payment checkout-form">
                ...
                <?php foreach ($data_rekening as $row) { ?>
                    <div class="checkout-payment__item">
                        ...
                        <?php echo form_open_multipart('myorder/bayardp'); ?>
                        <div class="checkout-payment__item-content">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="hidden" class="form-control" name="rekening_dp" value="<?= $row->nama_bank ?>">
                                </div>
                            </div>
                            <div class="box-field" style="margin-top: 10px;">
                                ...
                                <?php foreach ($pembelian as $r) {
                                    ...
                                    $hasil = $a * 50 / 100;
                                ?>
                                    <input type="number" class="form-control" name="bayar" min="<?= $hasil ?>" required>
                                <?php } ?>
                            </div>
                            <div class="box-field" style="margin-top: 10px;">
