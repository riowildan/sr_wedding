        ...
        <div class="detail-block__content">
            ...
            <ul class="bread-crumbs">
                <li class="bread-crumbs__item">
                    <a href="<?php echo base_url('/') ?>" class="bread-crumbs__link">Home</a>
                </li>
                        ...
                        <div style="padding: 10px">
                            <a href="<?= base_url('shop/detail/' . $row->id) ?>">
                                <div style="text-align: center;">
                                    <img name="foto" src="<?php echo base_url() . 'assets/assets-admin/foto-produk/' . $row->foto; ?>" width="262px" height="262px" class="js-img" alt="">
